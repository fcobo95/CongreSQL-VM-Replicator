...
sub _increment_octets_be;
sub _increment_octets_le;
sub _radix_to_bin;
sub decode_json($;$) ;
sub encode_json($) ;
}
...
package DBD::Oracle {
sub OCI_BATCH_ERRORS;
sub OCI_BATCH_MODE;
sub OCI_COMMIT_ON_SUCCESS;
sub OCI_DBSHUTDOWN_ABORT;
sub OCI_DBSHUTDOWN_FINAL;
sub OCI_DBSHUTDOWN_IMMEDIATE;
sub OCI_DBSHUTDOWN_TRANSACTIONAL;
sub OCI_DBSHUTDOWN_TRANSACTIONAL_LOCAL;
sub OCI_DBSTARTUPFLAG_FORCE;
sub OCI_DBSTARTUPFLAG_RESTRICT;
sub OCI_DESCRIBE_ONLY;
sub OCI_EXACT_FETCH;
sub OCI_FETCH_ABSOLUTE;
sub OCI_FETCH_CURRENT;
sub OCI_FETCH_FIRST;
sub OCI_FETCH_LAST;
sub OCI_FETCH_NEXT;
sub OCI_FETCH_PRIOR;
sub OCI_FETCH_RELATIVE;
sub OCI_FO_ABORT;
sub OCI_FO_BEGIN;
sub OCI_FO_END;
sub OCI_FO_ERROR;
...
sub OCI_FO_SESSION;
sub OCI_FO_TXNAL;
sub OCI_KEEP_FETCH_STATE;
sub OCI_NON_BLOCKING;
sub OCI_PARSE_ONLY;
sub OCI_PRELIM_AUTH;
sub OCI_SHOW_DML_WARNINGS;
sub OCI_STMT_SCROLLABLE_READONLY;
sub ORA_BLOB;
sub ORA_CHAR;
sub ORA_CHARZ;
sub ORA_CLOB;
...
sub fetchrow_arrayref;
sub finish;
sub ora_bind_param_inout_array;
sub ora_execute_array;
sub ora_fetch;
sub ora_fetch_scroll;
sub ora_scroll_position;
sub ora_stmt_type;
sub ora_stmt_type_name;
sub rows;
}
package DBD::Pg {
sub PG_ABSTIME() ;
